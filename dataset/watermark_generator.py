...
class SimpleTextWatermark:
    ...
    def __init__(self):
        self.texts = [
            "CONFIDENTIAL","COPY","SAMPLE","DRAFT","PROPERTY","DO NOT SHARE","PRIVATE",
            "PROTECTED","FOR INTERNAL USE","PREVIEW","NOT FOR DISTRIBUTION","WATERMARK",
            "SECURE","© Company","TM","UNAUTHORIZED","RESTRICTED","ARCHIVE","ORIGINAL",
            "COPYRIGHT","CLIENT ONLY","DIGITAL","COPYRIGHTED","SENSITIVE","PERSONAL",
            "TEST","EXCLUSIVE","DEMO","INTERNAL","PROOF","NOT FINAL","UNPUBLISHED","TOP SECRET",
            "SAMPLE ONLY","VIEW ONLY","TRIAL","FOR REVIEW","NOT LICENSED","SOLD","LICENSED",
            "NO REPRODUCTION","FOR APPROVAL","CONFIDENTIAL DRAFT","PROPERTY OF COMPANY",
            "DO NOT PRINT","DO NOT COPY","© 2025","COPYRIGHT RESERVED","NOT FOR SALE",
            "KEEP PRIVATE","EMBARGOED","VERIFIED","AUTHENTIC","ORIGINAL ARTIFACT","INSPECT",
            "QC","TEMPORARY","SAMPLE-DO-NOT-USE","CHECK","NON-PUBLIC","INTERNAL USE ONLY",
            "CLIENT COPY","WIP","WORK-IN-PROGRESS","UNAUTHORIZED COPYING","EXAMPLE",
            "STAGING","BACKUP","MIGRATION","LEGACY","REFERENCE","HOLD"
        ]
